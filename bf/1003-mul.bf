...
# block 0 stores the result
# block 1 holds the value to multiply
# block 2 holds the amount of times to multiply
# the result of  input of 42 will output the result of 4*2
# read into block 1 and 2
# subtract 48 from each: '0'
# loop while block 2 != 0 adding the value of block 1 to block 0 each time
