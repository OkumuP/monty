...
/**
 * struct stack_s - doubly linked list representing of a stack or queue
 * @n: this is the integer
 * @prev: previous element pointer in a stack or queue
 * @next: next element pointer in a stack or queue
 *
...
/**
 * struct instruction_s - the opcode and the functions
 * @opcode: the opcode
